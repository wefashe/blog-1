...
### 3.4 自定义样式
在 `/themes/next/source/css/_custom/custom.styl` 文件中添加代码可以自定义样式，我的 [设置](https://github.com/dldylan/blog/blob/hexo-source/themes/next/source/css/_custom/custom.styl) 可以在 GitHub 中找到。
...
在主题配置文件里的设置方法和上面链接的设置一样，加入以下内容：
...
我目前没有采用这种备份同步方式，而是选择了用 Travis CI 进行自动处理，具体方法可以查看 [Hexo遇上Travis-CI：可能是最通俗易懂的自动发布博客图文教程](https://juejin.im/post/5a1fa30c6fb9a045263b5d2a)。
