...
### 3.4 自定义样式
在 `/themes/next/source/css/_custom/custom.styl` 文件中添加代码可以自定义样式，我的设置可以看 [这里](https://github.com/dongleizhang/blog/blob/hexo-source/themes/next/source/css/_custom/custom.styl)。
